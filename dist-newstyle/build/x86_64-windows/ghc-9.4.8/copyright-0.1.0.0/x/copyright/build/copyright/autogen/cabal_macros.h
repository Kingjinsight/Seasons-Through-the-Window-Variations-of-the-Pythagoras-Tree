...
/* package copyright-0.1.0.0 */
#ifndef VERSION_copyright
#define VERSION_copyright "0.1.0.0"
#endif /* VERSION_copyright */
#ifndef MIN_VERSION_copyright
#define MIN_VERSION_copyright(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_copyright */
...
#define CURRENT_COMPONENT_ID "copyright-0.1.0.0-inplace-copyright"
